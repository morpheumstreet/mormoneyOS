...
| 5. Build system prompt     | `buildSystemPrompt`                                                 | `BuildSystemPrompt`                                                                                                                                                                             | ✅ TS-aligned: status, credits, tier, genesis, lineageSummary; skills via SkillLoader + FormatForPrompt when SkillsConfig set |
...
| Skills           | ✅                      | ✅                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | SkillLoader (SKILL.md/SKILL.toml merge when path set), prompt injection via FormatForPrompt; strategies from DB; see skills-design.md                                                                                                                               |
...
- ~~**Skills prompt injection:** SkillLoader + FormatForPrompt~~ ✅ **Done:** `internal/skills/loader.go` (LoadAllFromStore, SKILL.md/SKILL.toml merge); `BuildSystemPrompt` injects via `FormatForPrompt` when SkillsConfig set.
- ~~Soul system: view_soul, update_soul, reflect_on_soul, view_soul_history~~ ✅
...
- Skills prompt injection (SkillLoader, SKILL.md/SKILL.toml merge, FormatForPrompt)
